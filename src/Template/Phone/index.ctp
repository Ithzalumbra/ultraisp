 ...
 * @var \App\Model\Entity\Phone[]|\Cake\Collection\CollectionInterface $phone
 */
?>
...
<div class="phone index large-9 medium-8 columns content">
    <h3><?= __('Phone') ?></h3>
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('particular_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($phone->phone) ?></td>
                <td><?= $this->Number->format($phone->particular_id) ?></td>
                <td class="actions">
